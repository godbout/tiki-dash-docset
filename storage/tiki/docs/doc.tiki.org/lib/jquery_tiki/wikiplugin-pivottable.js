...
function stickyTableHeaders(pivotTableID, allowed){
    if (allowed === 'y') {
        var pivotTable="#output_"+pivotTableID;
        var tableRenderer = $(pivotTable).find(".pvtTable");
        var tableTh = $(pivotTable).find(".pvtTable th");
        tableRenderer.addClass("table-sticky");
        tableTh.addClass("bg-light");
    }
}
